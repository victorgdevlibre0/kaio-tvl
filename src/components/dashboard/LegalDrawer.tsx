  ...
  return (
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent className="max-h-[85vh]">
        ...
        <ScrollArea className="flex-1 overflow-auto px-4 pb-6">
          <article className="prose prose-invert prose-sm max-w-4xl mx-auto space-y-6 text-muted-foreground leading-relaxed">
            <p>
