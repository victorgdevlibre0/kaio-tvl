...
export const LegalDrawer = ({ children }: { children: React.ReactNode }) => {
        ...
        <ScrollArea className="flex-1">
          <div className="px-6 py-6 space-y-6 text-sm text-muted-foreground leading-relaxed">
            ...
            <Section title="I. KAIO's Role — Technology Service Provider Only">
              <p>KAIO operates exclusively as a technology and tokenization service provider. In this capacity, KAIO provides distributed ledger technology infrastructure and tokenization rails that enable investment fund managers and issuers to represent interests in their funds in tokenized form on-chain.</p>
            ...
            <Section title="II. Third-Party Fund Issuers — Independence, No Association, No Endorsement">
              ...
              <p className="font-medium text-foreground/80 mt-3">(b) No review, approval, or verification by Fund Issuers.</p>
              ...
              <p className="font-medium text-foreground/80 mt-3">(c) No agency or distribution mandate.</p>
              ...
              <p className="font-medium text-foreground/80 mt-3">(d) Fund Issuer data — source and limitation.</p>
              ...
              <p className="font-medium text-foreground/80 mt-3">(e) Direct contact with Fund Issuers required.</p>
            ...
            <Section title="III. Data Accuracy — No Reliance; Information May Not Be Current">
              <p>The information displayed on this Platform, including any data relating to fund performance, net asset values, asset allocations, token prices, yields, on-chain positions, and market data, may not be current, complete, or accurate at the time of access and must not be relied upon for any investment or financial decision.</p>
              <p>Specifically:</p>
              <ul className="list-disc pl-6 space-y-1 my-2">
            ...
            <Section title="IV. This Is Not a Marketing Communication for Any Fund">
              <p>To the extent that this Platform constitutes a communication of any kind for regulatory purposes, it is a communication relating to KAIO's tokenization technology and infrastructure services — not a marketing communication in respect of any Third-Party Fund or the units or shares thereof.</p>
              <p>KAIO expressly does not intend this Platform to constitute marketing of any alternative investment fund within the meaning of Article 4(1)(x) of AIFMD, a financial promotion within the meaning of section 21 of the Financial Services and Markets Act 2000 ("FSMA"), an advertisement for a collective investment scheme within the meaning of section 251 of the Securities and Futures Act 2001 of Singapore ("SFA"), or any equivalent regulated communication under any applicable law.</p>
              <p>KAIO does not hold, and does not represent that it holds, any licence, authorisation, or registration permitting it to market, distribute, or solicit investment in any fund or financial product in any jurisdiction.</p>
            </Section>
            ...
            <Section title="V. No Offer or Solicitation; Geographic and Investor Restrictions">
              ...
              <p className="font-medium text-foreground/80 mt-3">(a) European Union / EEA.</p>
              ...
              <p className="font-medium text-foreground/80 mt-3">(b) United Kingdom.</p>
              ...
              <p className="font-medium text-foreground/80 mt-3">(c) Singapore.</p>
              ...
              <p className="font-medium text-foreground/80 mt-3">(d) United States.</p>
            ...
            <Section title="VIII. Offering Documentation Primacy">
              <p>Before entering into any transaction in respect of any Third-Party Fund referenced on this Platform, you must obtain, read, understand, and accept the terms set out in the most recent version of the relevant offering documentation as made available by the relevant Fund Issuer or its authorised administrator. Copies are available directly from the relevant Fund Issuer upon request.</p>
              <p>Nothing on this Platform replaces or supersedes the terms of any fund's offering documentation. In the event of any inconsistency between information on this Platform and the relevant offering documentation, the offering documentation shall prevail in all respects without exception.</p>
            </Section>

            <Section title="IX. Recording; Personal Data; AML">
              <p>To the extent permitted by applicable law, KAIO may record telephone calls and monitor electronic communications for legal, regulatory, and internal policy compliance purposes. Personal data will be collected, stored, and processed in accordance with our <a href="https://www.kaio.xyz/privacy-policy" target="_blank" rel="noopener noreferrer" className="underline underline-offset-2 text-primary hover:text-primary/80 transition-colors">Privacy Policy</a> and applicable data protection legislation, including the GDPR (Regulation (EU) 2016/679) and the UK GDPR. On-chain data, including wallet addresses, may be immutable and may not be capable of deletion in satisfaction of applicable data subject rights.</p>
            </Section>

            <Section title="X. Limitation of Liability">
              <p>To the fullest extent permitted by applicable law, KAIO, its directors, officers, employees, agents, and affiliates shall not be liable for any loss or damage — direct, indirect, consequential, or otherwise — arising from: access to or use of the Platform; reliance on any data or information herein; inaccuracy or incompleteness of fund data; technology failure, smart contract malfunction, or key management failure; any investment decision made in connection with the Platform; or any regulatory action taken against any user. Nothing herein limits liability for fraud or any liability that cannot be excluded under applicable law.</p>
            </Section>

            <Section title="XI. Governing Law and Amendment">
              <p>This Disclaimer is governed by English law. KAIO reserves the right to amend this Disclaimer at any time without prior notice. The version published at the time of access governs. Continued access constitutes acceptance.</p>
            </Section>
